...
@Model
class Missionary2: Identifiable, Codable {
    ...
    var fnamelname: String {
        ...
        guard let first = nameComponents.first, let last = nameComponents.last else {
    ...
    init(name: String, photoName: String, city: String, state: String, country: String, startDate: String, endDate: String, hobbies: String, title: String) {
        self.name = name
